...
**Bandersnatch** es una película interactiva presentada como un episodio de Black Mirror ambientada en 1984 cuya trama es la de un programador que comienza a cuestionar la realidad mientras adapta una novela de fantasía a un videojuego ([Netflix](https://www.netflix.com/es/title/80988062). Esta, representa un avance en la narrativa del cine ya que se brinda una serie de opciones para que el usuario decida qué camino quiere que tome la historia, de esta forma, los espectadores participan activamente en la trama.
